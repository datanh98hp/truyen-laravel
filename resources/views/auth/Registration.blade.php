                ...
                <div class="login-wrap">
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            ...
                            <form action="{{route('register.custom')}}" method="post" id="reg-form">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="password" id="repassword" name="repassword" placeholder="Password">
                                </div>
                                ...
                                <button class="au-btn au-btn--block au-btn--green m-b-20" type="button" onclick="submit()">register</button>
